...
const aurora1: Room = {
  ...
  items: [i("crystal", 9, 1, "au1-c1"), i("fish", 4, 4, "au1-f1"), i("medal", 14, 4, "au1-m1"), i("chick", 4, 8, "au1-ch1")],
  exits: [
...
const vrak2: Room = {
  ...
  items: [i("fish", 9, 2, "vr2-f1"), i("crystal", 4, 5, "vr2-c1"), i("medal", 14, 8, "vr2-m1"), i("chick", 4, 11, "vr2-ch1")],
  exits: [
...
const palma: Room = {
  ...
  items: [i("flag", 4, 0, "pal-fl"), i("fish", 14, 0, "pal-f1"), i("medal", 9, 8, "pal-m1"), i("chick", 1, 12, "pal-ch1")],
  exits: [
...
const ledovec: Room = {
  ...
  items: [i("crystal", 9, 1, "le-c1"), i("fish", 4, 4, "le-f1"), i("medal", 14, 4, "le-m1"), i("chick", 1, 12, "le-ch1")],
  exits: [
...
const katedra: Room = {
  ...
  items: [i("crystal", 9, 1, "kat-c1"), i("medal", 4, 3, "kat-m1"), i("medal", 14, 3, "kat-m2"), i("chick", 18, 12, "kat-ch1")],
  exits: [
...
const magArchipelag: Room = {
  ...
  items: [i("flag", 1, 1, "ma1-fl"), i("flag", 18, 1, "ma1-fl2"), i("medal", 9, 9, "ma1-m1"), i("chick", 1, 12, "ma1-ch1")],
  exits: [
