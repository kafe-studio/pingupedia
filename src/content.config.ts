...
const ochrana = defineCollection({
  loader: glob({ pattern: "ochrana.json", base: "./src/content/pages" }),
  schema: ochranaSchema,
});

export const collections = { species, site, home, oProjektu, hry, quiz, filmy, timeline, chovy, ochrana };
