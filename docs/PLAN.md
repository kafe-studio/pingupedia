...
- [ ] Run 001 — cleanup kostra, site config, brand → `docs/sprints/001-foundation/run-001-cleanup-brand.md`
- [ ] Run 002 — layout, barevné schéma, obrázková pravidla (no-crop util)
